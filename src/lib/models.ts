...
export const FORECASTERS: ForecasterMeta[] = [
  ...
  { id: "gpt-oss-120b", name: "GPT-OSS 120B", provider: "OpenAI", emoji: "🧠", color: "#10A37F", kind: "model", region: "US", costIn: 0.04, costOut: 0.18 },
...
export const MODEL_COLORS: Record<string, { primary: string; bg: string; text: string }> = {
  ...
  "gpt-oss-120b": { primary: "#10A37F", bg: "bg-emerald-500/10", text: "text-emerald-400" },
